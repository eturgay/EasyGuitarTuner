...
#define MAX_MODEL_ORDER 500
#define MAX_ITERATION 1000


extern float signal1[SIGNAL_LENGTH];
extern float signal2[SIGNAL_LENGTH];
extern float signal3[SIGNAL_LENGTH];
...
extern int peaklist[20];
extern float firstHarmonic;
...
extern float testSignalString[SIGNAL_LENGTH];
